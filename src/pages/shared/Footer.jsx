...
const Footer = () => {
    return (
        <div>
         <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100 mt-48 bottom-0">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
            ...
            {/* <h1 className="font-medium text-base">Local Tour & Guide</h1> */}
				<span className="self-center text-2xl font-semibold">Local Tour & Guide</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3">
				<h3 className="uppercase dark:text-gray-50">Contacts With Us</h3>
				<ul className="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#">01621715276</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Chittagong</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">tanjinasultana388@gmail.com</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
