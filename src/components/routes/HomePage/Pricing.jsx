            ...
            <div className="flex flex-wrap items-stretch -mx-4">
                <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                    <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                        ...
                        <p className="mt-3 leadi dark:text-gray-400">Including 1000 Peoples are took this service for a beautiful memories.</p>
                        <ul className="flex-1 mb-6 dark:text-gray-400">
                            <li className="flex mb-2 space-x-2">
                                ...
                                <span>Ethnic and Cultural Immersion</span>
                            </li>
                            <li className="flex mb-2 space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-shrink-0 w-6 h-6 dark:text-violet-400">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                </svg>
                                <span>Less costing</span>
                            </li>
                            <li className="flex mb-2 space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-shrink-0 w-6 h-6 dark:text-violet-400">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                </svg>
                                <span>Overnight Glamping</span>
                            </li>
                        </ul>
                ...
                <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                    <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-violet-400 dark:text-gray-900">
                        ...
                        <p className="leadi">Including 2000 Peoples are took this service for a beautiful memories.</p>
                ...
                <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                    <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                        ...
                        <p className="leadi dark:text-gray-400">Including 3000 Peoples are took this service for a beautiful memories.</p>
                        <ul className="space-y-2 dark:text-gray-400">
                            ...
                            <li className="flex items-start space-x-2">
                                ...
                                <span>Art or Antiques Shopping Tours</span>
                            </li>
                        </ul>
