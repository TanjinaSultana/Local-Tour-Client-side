...
const Login = () => {
	...
	<form novalidate="" action="" className="space-y-6">
		...
		<button className="block w-full text-xl p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400">Login</button>
	</form>
	...
	<p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
		<NavLink to='/register' rel="noopener noreferrer"  className="underline dark:text-gray-100">Register</NavLink>
	</p>
</div>
        </div>
    );
